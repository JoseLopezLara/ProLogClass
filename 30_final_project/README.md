...
#### Make a Eliza system exper with next traits

* To the First Part of final project you need add the knowledge base of your genealical family tree to eliza code and then, you need add templates, rules and repleaces to interact with eliza.

* To the Second Part, you need add the knowledge base of next disease: Sarampion, Cancer de Mama y Gota. And then, you need add templates, rules and repleaces to interact with eliza.

* To the Theerth Part, you need add the knowledge base of them about your akinator diagram, that in mi case is HarryPotter Saga. And then, you need add templates, rules and repleaces to interact with eliza.

Each system expert to need has next

* 20 templates with one argument
* 5 templates with two arguments
* 5 templates with three arguments

Also...

* The diaseses and Harry Potter system exper to need has a investigation about them before code knowledge base.
...
#### **Diseas investigatio include Sarampion, Cancer de Mama and Gota**

* [Diseases investigation:](investigacion_sobre_las_enfermedades.md)

#### **Harry Potter investigation**

* [Harry Potter investigation:](investigacion_sobre_harry_potter.md)

### **Eliza**

#### **Templates of Family Tree System Expert**
...
#### **Templates of Diseases System Expert**
...
![image](testSE2_P1.png).
![image](testSE2_P2.png).

#### **Templates of Harry Potter System Expert**
